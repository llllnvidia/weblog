...
post_fields = {
    "id": fields.Integer(),
    "link": fields.String(attribute=lambda p:url_for("main.article", post_id=p.id, _external=True)),
    "body": fields.String(),
    ...
    "category_name": fields.String(attribute=lambda p: p.category.name if p.category else ""),
